...
resource "tls_private_key" "cbdb" {
  algorithm = "RSA"
}

resource "tls_self_signed_cert" "cbdb" {
  private_key_pem = tls_private_key.cbdb.private_key_pem
...
resource "aws_acm_certificate" "cert" {
  private_key      = tls_private_key.cbdb.private_key_pem
  certificate_body = tls_self_signed_cert.cbdb.cert_pem
}
